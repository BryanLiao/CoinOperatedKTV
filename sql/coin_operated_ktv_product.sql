...
CREATE TABLE `product` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='產品';
...
INSERT INTO `product` VALUES (1,'一般單曲',10,0),(2,'新歌單曲',15,0),(3,'test',12,1),(4,'一般單曲1',10,1);
